...
<div class="dashboard-container">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="title-heading"><i class="fas fa-users me-2"></i> Kelola Pengunjung</h2>
  ...
  <div class="card card-dark mb-3">
    <div class="card-body">
      <form class="row g-2" method="GET" action="{{ route('pengunjungs.index') }}">
        <div class="col-md-8">
  ...
  <div class="card card-dark">
    <div class="card-body p-3">
      <div class="table-responsive">
        <table class="table table-hover table-striped align-middle text-center">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ method_exists($pengunjungs,'firstItem') ? $pengunjungs->firstItem()+$i : $i+1 }}</td>
              ...
              <td>
                ...
                <form action="{{ route('pengunjungs.destroy',$p->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus pengunjung ini?')">
                  @csrf @method('DELETE')
      ...
      @if(method_exists($pengunjungs,'links'))
        <div class="mt-3">{{ $pengunjungs->appends(request()->query())->links() }}</div>
      @endif
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <form action="{{ route('pengunjungs.store') }}" method="POST">
      ...
      <div class="modal-content bg-dark text-white">
        <div class="modal-header"><h5 class="modal-title">Tambah Pengunjung</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <form id="formEdit" method="POST">
      @csrf @method('PUT')
      <div class="modal-content bg-dark text-white">
        <div class="modal-header"><h5 class="modal-title">Edit Pengunjung</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
        <div class="modal-body">
...
<script>
  document.addEventListener('click', function(e){
    if(e.target.closest('.btn-edit')){
      ...
      form.action = "{{ url('/admin/pengunjungs') }}/" + id;
